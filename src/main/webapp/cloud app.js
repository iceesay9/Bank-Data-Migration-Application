            ...
            app.controller("CustomerController", function($scope, $http) {
             ...
             // In case of edit, populate form fields and assign form.id with customer id
                $scope.editCustomer = function(customer) {
                    ...
                    $scope.customerForm.accountNumber = customer.accountNumber;
                    $scope.customerForm.accountType = customer.accountType;
                    $scope.customerForm.accountBalance = customer.accountBalance;
                ...
                function _clearFormData() {
                    ...
                    $scope.customerForm.accountNumber = "";
                    $scope.customerForm.accountType = "";
                    $scope.customerForm.accountBalance = "";
...
<body ng-app="CustomerManagement" ng-controller="CustomerController">
	...
	<h2>Total bank customers  : {{customers.length}} </h2>
	<form ng-submit="submitCustomer()">
		<table>
			...
			<tr>
				...
				<td><input type="text" ng-model="customerForm.accountNumber" /></td>
			</tr>
			<tr>
				<td>Customer accountType</td>
				<td><input type="text" ng-model="customerForm.accountType" /></td>
			</tr>
			<tr>
				<td>Customer accountBalance</td>
				<td><input type="text" ng-model="customerForm.accountBalance" /></td>
			</tr>
			<tr>
